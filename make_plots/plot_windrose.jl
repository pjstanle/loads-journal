...
gca().yaxis.set_ticklabels(["1%","2%","3%"],horizontalalignment="left")
...
gca().yaxis.set_ticklabels(["10 m/s","12 m/s"],horizontalalignment="center")
title("wind speeds",fontsize=10,y=1.1)

subplots_adjust(top=0.85,bottom=0.1,left=0.05,right=0.95,wspace=0.3)
savefig("windrose_uni.pdf", transparent=true)
